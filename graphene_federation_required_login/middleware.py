...
class AuthorizationMiddleware(object):
    def resolve(self, next, root, info, **kwargs):
        _GRAPHENE_FEDERATION_HEADER = 'GRAPHENE_FEDERATION_HEADER'
        if settings.GRAPHENE_FEDERATION_HEADER:
            _GRAPHENE_FEDERATION_HEADER = settings.GRAPHENE_FEDERATION_HEADER
        if settings.DEBUG:
